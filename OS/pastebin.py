...
fields.append(('author', 'Fidèle Destrier'))
fields.append(('lexer', '%s' % 'text' if sys.argv == [''] else sys.argv[1]))

request = urllib2.Request('http://pastebin.geany.org/api/',
